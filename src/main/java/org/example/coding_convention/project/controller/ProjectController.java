...
public class ProjectController {
    ...
    @PostMapping("/create")
    public BaseResponse projectCreate(@RequestBody ProjectDto.ProjectReq dto) {
        projectService.save(dto);
        return BaseResponse.success("성공");
    }

//    @GetMapping("/list")
//    public BaseResponse projectList() {
//        ProjectDto.ProjectList result = projectService.list();
